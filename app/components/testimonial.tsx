...
} from "@/constants/framer/testimonial-animation";
...
export const Testimonial = () => {
    return (
        <motion.section
            ...
            className="w-full px-6 mb-12 flex flex-col items-center md:px-16 md:mb-24 lg:container lg:mx-auto lg:mb-36"
        >
            <motion.span
            ...
            <motion.div variants={testimonialAnimation} className="w-full">
