...
import { containerAnimation } from "@/constants/framer/about-animation";
                ...
                >
                    ...
                    <div className="w-full flex flex-col items-center gap-y-4 lg:p-12 lg:w-2/3">
                        ...
                        >
                            ...
                            equipe dedicada, oferecemos cuidados personalizados, focando no
                            bem-estar. Fortalecemos laços entre você e seu amigo peludo, com
                            serviços veterinários de qualidade. Seja para check-ups, tratamentos ou
                            emergências, estamos aqui para cada pata. Descubra na VetPet uma
                            abordagem calorosa e compassiva, onde a saúde encontra a felicidade, e
                            cada história de pata é uma história feliz.
                        </p>
                    </div>
                </Element>
            </motion.div>
